...
After which, we analysed the color distribution and pixel distributions to detect biases in data. We plot the data on multiple histograms using subplots, and the results were relatively centered at the mean (0), meaning that the data is well balanced and normalised. 

![image](https://user-images.githubusercontent.com/79783660/232287391-630bfc05-f2b0-428e-bafb-fdc638f5d633.png)


Finally, we analysed the PCA distribution using sklearn's library, to detect whether the images are distinct and classifiable. The plot shows distinct groups of images where similar classes are grouped closely to each other, thus the normalisation has made it simpler for our CNN to classify the images.
...
## References
- Python 
   - https://www.python.org/ [online]
- CIFAR-10 Dataset 
   - https://www.cs.toronto.edu/~kriz/cifar.html [online]
- Pytorch 
...
- Fix Pytorch Influence Functions (1) 
   - https://github.com/nimarb/pytorch_influence_functions/issues/34 [online] 
- Fix Pytorch Influence Functions (2) 
   - https://github.com/expectopatronum/pytorch_influence_functions/commit/ecce2d27e3d46b3125bb3dd963beebd7a5407959 [online]
- Powerpoint Templates 
   - https://slidesgo.com/theme/computer-science-mathematics-major-for-college-software-media-applications#search-computer+science&position-4&results-34&rs=search [online]
